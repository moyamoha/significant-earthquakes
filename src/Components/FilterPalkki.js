    ...
    return (
        <div className="col-2 listapalkki">
           ...
           <div> 
            ...
            <div>
                <div>form..</div>
            <input placeholder="max" type="number" id="magnitudeMin" min="0" max="12" onChange={(e) => {changeFilterObj(sminyear, smaxyear, loc, e.target.value, smaxMagn, sminDeaths,smaxDeaths)}}></input>
            <div>to..</div>
            <input placeholder="min" type="number" id="magnitudeMax"  min="0" max="12" onChange={(e) => {changeFilterObj(sminyear, smaxyear, loc, sminMagn, e.target.value, sminDeaths,smaxDeaths)}}></input>
            </div>
            <label>Deaths:</label>
            <div>form..</div>
            <input id="deathMin" type="number" min="0" max="10 000" onChange={(e) => {changeFilterObj(sminyear, smaxyear, loc, sminMagn, smaxMagn, e.target.value,smaxDeaths)}}/>
            <div>to..</div>
            <input id="deathMax" type="number" min="0" max="10 000" onChange={(e) => {changeFilterObj(sminyear, smaxyear, loc, sminMagn, smaxMagn, sminDeaths, e.target.value)}}/>
